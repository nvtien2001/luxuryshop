                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <div class="right__formWrapper">
                            <form action="/admin/category-add" method="post" modelAttribute="category">
                            @csrf
                                ...
                                <div class="right__inputWrapper">
                                    <label>Mô tả</label>
									<textarea id="txtDetailDescription" class="form-control" name="description" value="{{$cate->description}}"></textarea>
                                </div>
